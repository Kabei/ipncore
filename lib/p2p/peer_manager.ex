defmodule Ippan.P2P.PeerManager do
  ...
  def handle_info(
    ...
    if :persistent_term.get(:vid) != validator_id and not Map.has_key?(peers, validator_id) do
      hostname = validator.hostname
  ...
  def handle_info(
    ...
    if :persistent_term.get(:vid) != validator_id do
